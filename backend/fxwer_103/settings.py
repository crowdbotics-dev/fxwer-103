"""
Django settings for fxwer_103 project.
...
WSGI_APPLICATION = 'fxwer_103.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fxwer_103 API",
    "DESCRIPTION": "API documentation for fxwer_103 App",
    "VERSION": "v1",
}
